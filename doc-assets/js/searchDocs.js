var BCLSfinder = ( function (window, document) {
    ...
    article = document.getElementsByTagName('article')[0],
        ...
        searchLink,
        homeLink,
        message = '<div stuyle="padding:1em;background-color:#EEEEEE"><p style="font-weight:bold">To serve you better going forward, the Brightcove documentation site has been completely revamped. The downside is that some of the links you have been using are changed, and we apologize in advance for any inconvenience this causes.</p> <p style="font-weight:bold">To get you as close as possible to the document you are seeking, an intelligent search has been implemented and will be executed when you click the Continue button located below. The search will very likely yield the desired document at or near the top of the returned list of documents.</p> <p style="font-weight:bold">Please take the time to re-bookmark the page once you find it on the new site.</p> <p style="font-weight:bold">For a video introduction to the new site, visit the <a id="homeLink" href="">home page</a> and watch the “Learn about the new Support site” video.</p><p style="text-align:center"><a id="searchLink" href=""><span class="bcls-button">Continue</span></a></p></div>';
