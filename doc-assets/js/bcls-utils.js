...
var BCLS_player_fix = ( function (window, document) {
    var vc,
        ...
        toggleStr = '<li><button id="vc" class="bcls-button__version" style="background-color:#293b70;">Video Cloud version</button> <button id="bp" class="bcls-button__version">Brightcove Player Version</button> <a style="font-size:smaller;" href="//docs.brightcove.com/en/players/brightcove-player/getting-started/versions.html">(What\'s the difference?)</a><hr></li>',
        iMax, i;
