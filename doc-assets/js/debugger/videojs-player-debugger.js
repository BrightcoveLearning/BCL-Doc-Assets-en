(function (global, factory) {
	...
	(global.videojsPlayerDebugger = factory(global.videojs));
...
var DebuggerPane = function (_videojs$getComponent) {
  _inherits(DebuggerPane, _videojs$getComponent);
  ...
  function DebuggerPane(player, options) {
    ...
    var _this = _possibleConstructorReturn(this, _videojs$getComponent.call(this, player, options));
  ...
  function intercept(method) {
    ...
    console[method] = function () {
      ...
      if (original.apply) {
        ...
        if ((typeof arguments === 'undefined' ? 'undefined' : _typeof$1(arguments)) == 'object') {
...
var getClassesStr$1 = function getClassesStr(obj) {
  if ((typeof obj === 'undefined' ? 'undefined' : _typeof$1(obj)) == 'object') {
...
var ButtonBarButton = function (_Button) {
  _inherits$1(ButtonBarButton, _Button);

  function ButtonBarButton(player, options) {
    _classCallCheck$1(this, ButtonBarButton);

    var _this = _possibleConstructorReturn$1(this, _Button.call(this, player, options));
...
var SliderToggle = function (_ButtonBarButton) {
  _inherits$2(SliderToggle, _ButtonBarButton);

  function SliderToggle(player, options) {
    _classCallCheck$2(this, SliderToggle);

    return _possibleConstructorReturn$2(this, _ButtonBarButton.call(this, player, options));
  }
...
var ClassListToggle = function (_ButtonBarButton) {
  _inherits$3(ClassListToggle, _ButtonBarButton);

  function ClassListToggle(player, options) {
    _classCallCheck$3(this, ClassListToggle);

    return _possibleConstructorReturn$3(this, _ButtonBarButton.call(this, player, options));
  }
...
var PlayerSettingsToggle = function (_ButtonBarButton) {
  _inherits$4(PlayerSettingsToggle, _ButtonBarButton);

  function PlayerSettingsToggle(player, options) {
    _classCallCheck$4(this, PlayerSettingsToggle);

    return _possibleConstructorReturn$4(this, _ButtonBarButton.call(this, player, options));
  }
...
var PlaybackInfoToggle = function (_ButtonBarButton) {
  _inherits$5(PlaybackInfoToggle, _ButtonBarButton);

  function PlaybackInfoToggle(player, options) {
    _classCallCheck$5(this, PlaybackInfoToggle);

    return _possibleConstructorReturn$5(this, _ButtonBarButton.call(this, player, options));
  }
...
var AdSettingsToggle = function (_ButtonBarButton) {
  _inherits$6(AdSettingsToggle, _ButtonBarButton);

  function AdSettingsToggle(player, options) {
    _classCallCheck$6(this, AdSettingsToggle);

    return _possibleConstructorReturn$6(this, _ButtonBarButton.call(this, player, options));
  }
...
var DebugLogToggle = function (_ButtonBarButton) {
  _inherits$7(DebugLogToggle, _ButtonBarButton);

  function DebugLogToggle(player, options) {
    _classCallCheck$7(this, DebugLogToggle);

    return _possibleConstructorReturn$7(this, _ButtonBarButton.call(this, player, options));
  }
  /**
     * Handle click to toggle between open and closed
     *
...
var setOptions = function setOptions(opt, player, callback) {
  var opts = {};
