var BCLS = (function(window, document) {
  var account_id_input = document.getElementById('account_id_input'),
    ...
    min_renditions = document.getElementById('min_renditions'),
    max_renditions = document.getElementById('max_renditions'),
    min_resolution_width = document.getElementById('min_resolution_width'),
    min_resolution_height = document.getElementById('min_resolution_height'),
    max_resolution_width = document.getElementById('max_resolution_width'),
    max_resolution_height = document.getElementById('max_resolution_height'),
    max_bitrate = document.getElementById('max_bitrate'),
    max_first_rendition_bitrate = document.getElementById('max_first_rendition_bitrate'),
    max_frame_rate = document.getElementById('max_frame_rate'),
    keyframe_rate = document.getElementById('keyframe_rate'),
    select_baseline_profile_configuration = document.getElementById('select_baseline_profile_configuration'),
